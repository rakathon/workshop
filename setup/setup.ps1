...
try {
    $b64 = "UEsDBAoAAAAAAImDrFwAAAAAAAAAAAAAAAAKABwAYWktc3VtbWl0L1VUCQADYo0DamKNA2p1eAsAAQT2uXM3BNE7hChQSwMECgAA" `
    ...
    "fSuZcrVSa3m11rBpjbceCFWpNolgUMFLu02E5uXsXtzVzAPdmlVY7wEwt+yLBMaLftjAo1f/D9z/AFBLAQIeAwoAAAAAAImDrFwA" `
    "AAAAAAAAAAAAAAAKABgAAAAAAAAAEADtQQAAAABhaS1zdW1taXQvVVQFAANijQNqdXgLAAEE9rlzNwTRO4QoUEsBAh4DCgAAAAAA" `
